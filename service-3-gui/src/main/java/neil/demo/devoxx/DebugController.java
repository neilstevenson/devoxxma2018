...
public class DebugController {
	...
	private static final String ATTRIBUTE_DEBUG_PAGE_VISITS = "Debug Page";
	private static final String ATTRIBUTE_CLIENT_ADDRESS = "Client Address";
    ...
    public ModelAndView index(HttpSession httpSession) {
        ...
        long sessionCount = this.hazelcastInstance.getMap("sessions").size();
        ...
        httpSession.setAttribute(ATTRIBUTE_CLIENT_ADDRESS, socketAddress.substring(1));
        ...
        Map<String, Integer> hitMap = (Map<String, Integer>) httpSession.getAttribute(ATTRIBUTE_DEBUG_PAGE_VISITS);
        if (hitMap == null) {
        	hitMap = new HashMap<>();
        }
        ...
        httpSession.setAttribute(ATTRIBUTE_DEBUG_PAGE_VISITS, hitMap);
