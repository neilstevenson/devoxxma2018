...
public class IndexController {
	...
	private static final String ATTRIBUTE_MAIN_MENU_VISITS = "Main Menu";
	...
	public String index(HttpSession httpSession, HttpServletRequest httpServletRequest) {
		...
		String socketAddress = this.hazelcastInstance.getLocalEndpoint().getSocketAddress().toString();
		...
		Map<String, Integer> hitMap = (Map<String, Integer>) httpSession
				.getAttribute(ATTRIBUTE_MAIN_MENU_VISITS);
		if (hitMap == null) {
			hitMap = new HashMap<>();
		}
		...
		httpSession.setAttribute(ATTRIBUTE_MAIN_MENU_VISITS, hitMap);
